...
<a class="waves-effect waves-light btn-large" href="allowed.php">Refresh</a>

<div class='container' style='margin-top: 100px;'><h3 style='color: white'><b>List of allowed Entries through the door:</b></h3><br>


<?php

$rfiles = glob("Authorized/*.*");
